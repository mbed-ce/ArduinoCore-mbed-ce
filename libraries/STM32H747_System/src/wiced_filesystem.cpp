...
mbed::MBRBlockDevice   *mbr_bd = NULL;
mbed::FATFileSystem    *wifi_fs = NULL;
...
{
    WPRINT_WHD_ERROR(("Please run the \"STM32H747_System > WiFiFirmwareUpdater\" sketch once to install the WiFi firmware.\n\r"));
    whd_print_logbuffer();
    while (1) {}
}
...
{
    wifi_fs = new mbed::FATFileSystem(mounted_name);
