...
uint8_t USBMIDI::getProductVersion()
{
    return 8;
}
...
bool USBMIDI::callback_set_configuration(uint8_t configuration)
{
    assert_locked();
...
const uint8_t *USBMIDI::configuration_desc(uint8_t index)
{
    ...
    uint8_t config_descriptor_temp[] = {
            ...
            0x09, 0x04, static_cast<uint8_t>(pluggedInterface + 1), 0x00, 0x02, 0x01, 0x03, 0x00,
